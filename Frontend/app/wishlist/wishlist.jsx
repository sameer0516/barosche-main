        ...
        return (
            <div className="wl-page">
                <div className="wl-container">
                    <h1 className="wl-title" style={{ position: 'absolute', width: 1, height: 1, overflow: 'hidden', clip: 'rect(0,0,0,0)' }}>
                        My Wishlist
                    </h1>
                    <div className="wl-empty">
                        <p className="wl-empty-sub">Loading...</p>
                    </div>
                </div>
            </div>
        );
                                        ...
                                        <div className="wl-card-info">
                                            ...
                                            <div className="wl-card-pricing">
                                                {oldPrice && Number(oldPrice) > Number(price) && (
                                                    <del className="wl-old-price">
                                                        {formatPrice(Number(oldPrice), currency)}
                                                    </del>
                                                )}
                                                <span className="wl-new-price">
