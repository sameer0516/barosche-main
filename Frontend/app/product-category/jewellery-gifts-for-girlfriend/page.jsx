...
const PAGE_URL = "https://barosche.com/product-category/jewellery-gifts-for-girlfriend/";
const OG_IMAGE = "/Meta-image-1.jpg";
const TITLE = "Buy Jewellery Gifts for Girlfriend – Romantic & Timeless ";
const DESCRIPTION =
  "Shop jewellery gifts for your girlfriend at Barosche. Discover romantic rings and elegant pieces designed for meaningful moments, timeless style, and everyday wear. ";
...
const schemaData = [
  ...
  // 1. CollectionPage schema (Dynamic)
  {
    ...
    url: PAGE_URL,
    name: TITLE,
    headline: "Jewellery Gifts for Girlfriend – Elegant Modern Designs",
    description: DESCRIPTION,
    inLanguage: "en",
    ...
    primaryImageOfPage: {
      ...
      caption: "Barosche Jewellery Gifts for Girlfriend Collection",
    },
  ...
  // 2. BreadcrumbList schema (Dynamic)
  {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Jewellery Gifts for Girlfriend", item: PAGE_URL },
    ],
  },
  ...
  // 3. ItemList schema
  {
    ...
    name: "Jewellery Gifts for Girlfriend Collection",
    description: "Explore 25 jewellery gift designs for girlfriend from the Barosche collection.",
    url: PAGE_URL,
    numberOfItems: 25,
  ...
  // 4. FAQPage schema
  {
    ...
    "@id": `${PAGE_URL}#faq`,
    url: `${PAGE_URL}#faq`,
    name: "Frequently Asked Questions About Jewellery Gifts for Girlfriend",
