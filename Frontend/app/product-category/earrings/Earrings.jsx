...
const EarringContent = [
    ...
    { type: 'p', text: "<a href='/product-category/earrings/' style='color: #007bff; text-decoration: underline;'>Everyday earrings</a> are thoughtfully designed for women who prefer effortless, practical, and stylish fashion. Crafted with lightweight materials and smooth finishing, these earrings ensure maximum comfort, allowing you to wear them throughout the day without irritation or heaviness." },
    ...
    { type: 'p', text: "Every pair of earrings deserves beautiful presentation, especially when given as a gift. Elegant packaging enhances the overall gifting experience and makes the moment more special." },
