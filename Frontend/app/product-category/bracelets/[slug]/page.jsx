...
export async function generateStaticParams() {
    return generateCategoryStaticParams('Bracelets');
}
...
export async function generateMetadata({ params }) {
    ...
    const pageUrl = `${siteUrl}/product-category/bracelets/${product.slug}`;
    ...
    const title = `${product.title || product.name} | Barosche Bracelets`;
...
export default async function BraceletsDetailPage({ params }) {
    ...
    return (
        <>
            ...
            <BraceletsDetailClient slug={slug} />
        </>
    );
}