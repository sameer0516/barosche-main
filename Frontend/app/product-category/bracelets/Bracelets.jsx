...
const bracelets_content = [
    ...
    { type: 'p', text: "<h3>1. Minimal Bracelets for Everyday Elegance</h3>" },
    ...
    { type: 'p', text: "<h3>2. Gold Bracelets – Classic Luxury & Timeless Appeal</h3>" },
    ...
    { type: 'p', text: "<h3>3. Bracelets for Men – Bold & Masculine Designs</h3>" },
    ...
    { type: 'p', text: "<h3>4. Gold Bracelets for Women – Elegant & Stylish</h3>" },
    ...
    { type: 'p', text: "<h3>5. Statement Bracelets – Designed to Stand Out</h3>" },
    ...
    { type: 'p', text: "<h3>6. Gemstone Bracelets – Colorful & Meaningful Designs</h3>" },
    ...
    { type: 'p', text: "<h3>1. Geometric Bracelets</h3>" },
    ...
    { type: 'p', text: "<h3>2. Stackable Bracelets</h3>" },
    ...
    { type: 'p', text: "<h3>3. Textured & Artistic Bracelets</h3>" },
    ...
    { type: 'p', text: "<h3>4. Minimal Luxe Bracelets</h3>" },
    ...
    { type: 'p', text: "<h3>5. Unisex Bracelets</h3>" },
    { type: 'p', text: "<a href='/product-category/bracelets/' style='color: #007bff; text-decoration: underline;'>Unisex bracelets </a>are designed with versatility in mind, making them suitable for both men and women. Their balanced and modern designs ensure effortless styling across different outfits and occasions." },
    ...
    { type: 'p', text: "<h3>1. Understand Your Style</h3>" },
    ...
    { type: 'p', text: "<h3>2. Select the Right Material</h3>" },
    ...
    { type: 'p', text: "<h3>3. Focus on Fit & Comfort</h3>" },
    ...
    { type: 'p', text: "<h3>4. Consider Versatility</h3>" },
    ...
    { type: 'p', text: "<h3>5. Check Craftsmanship</h3>" },
                ...
                <div style={{ flex: '1 1 300px', minWidth: '240px', padding: '24px 16px 24px 24px' }}>
                    <div style={{
                        ...
                        {activeItem ? (
                            ...
                            <img src="/placeholder.jpg" alt="placeholder" width={400} height={400}
                                style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                        )}
                    </div>
