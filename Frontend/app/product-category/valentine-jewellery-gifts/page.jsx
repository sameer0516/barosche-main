...
const PAGE_URL = "https://barosche.com/product-category/valentine-jewellery-gifts/";
const OG_IMAGE = "/Meta-image-1.jpg";
const TITLE = "Valentine Jewellery Gifts for Her – Elegant & Romantic ";
const DESCRIPTION =
  " Shop Valentine jewellery gifts for her at Barosche. Discover romantic and elegant pieces perfect for Valentine’s Day gifting, from timeless designs to everyday jewellery. ";
