...
const PAGE_URL = "https://barosche.com/product-category/gold-jewellery-gifts/";
const OG_IMAGE = "/Meta-image-1.jpg";
const TITLE = "Buy Gold Rings, Earrings, Pendants & Bracelets – Jewellery Gifts for Her ";
const DESCRIPTION =
  "Shop gold jewellery gifts at Barosche. Explore rings, earrings & gold bracelet gifts designed for meaningful gifting, timeless style, and elegant everyday wear.";
...
const schemaData = [
  ...
  // 3. ItemList schema
  {
    ...
    description: "Explore 25 gold jewellery gift designs from the Barosche collection.",
    url: PAGE_URL,
    numberOfItems: 25,
  ...
  // 4. FAQPage schema
  {
    ...
    "@id": `${PAGE_URL}#faq`,
    url: `${PAGE_URL}#faq`,
    name: "Frequently Asked Questions About Gold Jewellery Gifts",
