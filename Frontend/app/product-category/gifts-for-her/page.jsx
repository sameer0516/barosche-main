...
import GiftsFor from './GiftsFor';

const SITE_URL = "https://barosche.com";
const PAGE_URL = "https://barosche.com/product-category/gifts-for-her/";
const OG_IMAGE = "/Meta-image-1.jpg";
const TITLE = "Gifts for Her – Unique, Meaningful & Elegant Jewellery ";
const DESCRIPTION =
  " Shop gifts for her at Barosche. Discover unique, meaningful jewellery and elegant pieces designed for everyday wear and special moments she'll always remember. ";
...
const schemaData = [
  ...
  // 1. CollectionPage schema (Dynamic)
  {
    ...
    url: PAGE_URL,
    name: TITLE,
    headline: "Gifts for Her – Unique, Meaningful & Elegant Jewellery",
    description: DESCRIPTION,
    inLanguage: "en",
    ...
    primaryImageOfPage: {
      ...
      caption: "Barosche Gifts for Her Collection",
    },
  ...
  // 2. BreadcrumbList schema (Dynamic)
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Gifts for Her", item: PAGE_URL },
    ],
  },
  ...
  // 3. ItemList schema
  {
    ...
    name: "Gifts for Her Collection",
    description: "Explore 25 unique and meaningful jewellery gift designs for her from the Barosche collection.",
    url: PAGE_URL,
    numberOfItems: 25,
  ...
  // 4. FAQPage schema
  {
    ...
    "@id": `${PAGE_URL}#faq`,
    url: `${PAGE_URL}#faq`,
    name: "Frequently Asked Questions About Gifts for Her",
