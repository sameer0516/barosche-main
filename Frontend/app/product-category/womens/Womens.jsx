...
const womensContent = [
    ...
    { type: 'p', text: "<strong>Our gold jewellery for women is suitable for:</strong><br/>• Everyday elegant styling with minimal designs<br/>• Office and professional wear for a polished look<br/>• Festive and cultural occasions with traditional appeal<br/>• Weddings and special celebrations for a luxurious touch<br/>• Modern minimalist fashion looks for contemporary styling" },
    ...
    { type: 'h', text: "1. <a href='/product-category/earrings/' style='color: #007bff; text-decoration: underline;'>Earrings for Women</a>" },
    ...
    { type: 'h', text: "2. <a href='/product-category/rings/' style='color: #007bff; text-decoration: underline;'>Rings for Women</a>" },
    ...
    { type: 'h', text: "3. <a href='/product-category/pendants/' style='color: #007bff; text-decoration: underline;'>Pendants for Women</a>" },
    ...
    { type: 'h', text: "4. <a href='/product-category/bracelets/' style='color: #007bff; text-decoration: underline;'>Bracelets for Women</a>" },
    ...
    { type: 'p', text: "<strong>This makes our gold jewellery suitable for:</strong><br/>• Everyday minimal styling<br/>• Office and professional wear<br/>• Festive celebrations and cultural events<br/>• Weddings and special occasions<br/>• Modern fashion layering looks" },
    ...
    { type: 'p', text: "<strong>Our jewellery supports multiple styling needs:</strong>" },
    { type: 'p', text: "• Everyday casual styling with minimal and comfortable designs<br/>• Office and professional outfits for a polished appearance<br/>• Festive and cultural occasions with elegant detailing<br/>• Party and evening wear for a refined statement look<br/>• Modern layering and fashion experimentation for trend-driven styling" },
    ...
    { type: 'p', text: "<strong>Key modern trends include:</strong>" },
    ...
    { type: 'p', text: "<strong>We focus on delivering the following:</strong>" },
    { type: 'p', text: "• Premium craftsmanship with high-quality finishing<br/>• Trend-inspired yet timeless jewellery designs<br/>• Lightweight and comfortable pieces for everyday wear<br/>• Versatile styling suitable for multiple occasions<br/>• Durable materials with long-lasting shine and performance" },
    ...
    { type: 'p', text: "<strong>Popular styling trends include:</strong>" },
    { type: 'p', text: "• Minimalist and clean designs<br/>• Layered necklaces and stacked rings<br/>• Lightweight everyday gold-inspired styles<br/>• Mixed metal modern combinations<br/>• Statement pieces for bold styling" },
    ...
    { type: 'p', text: "• Secure payment and checkout system<br/>• High-quality product visuals<br/>• Clear and detailed product descriptions<br/>• Easy navigation and category filtering<br/>• Reliable and timely delivery service" },
    ...
    { type: 'p', text: "• Easy navigation and smooth browsing experience<br/>• High-quality product images and detailed descriptions<br/>• Secure checkout and payment options<br/>• Reliable and timely delivery services<br/>• Customer-focused shopping experience" },
