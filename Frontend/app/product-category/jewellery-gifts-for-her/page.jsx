...
import GiftsForHer from './GiftsForHer';

const SITE_URL = "https://barosche.com";
const PAGE_URL = "https://barosche.com/product-category/jewellery-gifts-for-her/";
const OG_IMAGE = "/Meta-image-1.jpg";
const TITLE = "Beautiful Jewellery Gifts for Her – Everyday & Elegant";
const DESCRIPTION =
  "Buy beautiful jewellery gifts for her at Barosche. Shop rings, earrings, pendants & bracelet gifts designed for everyday wear and meaningful moments.";
...
const schemaData = [
  ...
  // 2. BreadcrumbList schema
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Jewellery Gifts for Her", item: PAGE_URL },
    ],
  },
  ...
  // 3. ItemList schema
  {
    ...
    name: "Jewellery Gifts for Her Collection",
    description: "Explore 25 beautiful jewellery gift designs for her from the Barosche collection.",
    url: PAGE_URL,
    numberOfItems: 25,
  ...
  // 4. FAQPage schema
  {
    ...
    "@id": `${PAGE_URL}#faq`,
    url: `${PAGE_URL}#faq`,
    name: "Frequently Asked Questions About Jewellery Gifts for Her",
