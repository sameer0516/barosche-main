import GiftsForHerDetailClient from './GiftsForHerDetailClient.jsx';
...
export default async function GiftsForHerDetailPage({ params }) {
    const { slug } = await params;
    const product = await getProduct(slug);
    ...
    return (
        <>
            ...
            <GiftsForHerDetailClient slug={slug} />
        </>
    );
}