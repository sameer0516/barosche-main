        ...
        switch (metal) {
            case 'Gold':
                return {
                    ...
                    boxShadow: '0 2px 8px #c9a96e7345)',
                };
            case 'Silver':
                return {
                    background: 'linear-gradient(135deg, #c9a96e 0%, #e8c97a 50%, #b8873a 100%)',
        ...
        <div className="jd-delivery-section">
            ...
            <div className="jd-delivery-item">
                ...
                <div className="jd-delivery-info">
                    ...
                    <span className="jd-delivery-sub">Germany: 2 – 3 Working Days | EU: 2 – 4 Working Days</span>
                </div>
                <div className="jd-delivery-right">
                    <span className="jd-delivery-price">+€50</span>
                </div>
            </div>
        </div>
    );
...
export default function newInDetailClient({ slug }) {
    ...
    const [selectedMetal, setSelectedMetal] = useState('All');  // ← NEW
    ...
    }, [product, selectedVariantIndex, qty, selectedColor, selectedMetal, stoneColors]);
    ...
    // ── NEW: allMetalTypes + filteredVariants ──
                    ...
                    <section className="jd-related-section">
                        ...
                        <div className="jd-related-grid">
                            {relatedProducts.map((rp) => (
                                <Link
                                    key={rp._id || rp.slug}
                                    href={`/product-category/new-in/${rp.slug}`}
