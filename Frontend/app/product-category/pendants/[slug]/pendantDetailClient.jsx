...
const rebuildUI = (translations) => {
  ...
  return {
    ...
    labels: {
      ...
      wishlistAdd: g(), wishlistRemove: g(), vatIncluded: g(),
      sale: g(), youMayAlsoLike: g(), returnToCollection: g(),
      productNotFound: g(), reviews: g(),
    },
    delivery: {
...
// ── DeliverySection: currency prop add kiya, express price converted ──
                    ...
                    <section className="jd-related-section">
                        ...
                        <div className="jd-related-grid">
                            {relatedProducts.map((rp) => (
                                <Link
                                    key={rp._id || rp.slug}
                                    href={`/product-category/pendants/${rp.slug}`}
