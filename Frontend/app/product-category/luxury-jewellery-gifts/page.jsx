...
import LuxuryJewellery from './LuxuryJewellery';

const SITE_URL = "https://barosche.com";
const PAGE_URL = "https://barosche.com/product-category/luxury-jewellery-gifts/";
const OG_IMAGE = "/Meta-image-1.jpg";
const TITLE = "Buy Luxury Jewellery Gifts for Her – Effortless Timeless Style ";
const DESCRIPTION =
  "Buy luxury jewellery gifts for her at Barosche. Discover elegant, high-quality pieces designed for timeless style, meaningful gifting, and refined everyday wear.";
...
const schemaData = [
  ...
  // 1. CollectionPage schema (Dynamic)
  {
    ...
    url: PAGE_URL,
    name: TITLE,
    headline: "Luxury Jewellery Gifts – Effortless Timeless Style for Her",
    description: DESCRIPTION,
    inLanguage: "en",
    ...
    primaryImageOfPage: {
      ...
      caption: "Barosche Luxury Jewellery Collection",
    },
  ...
  // 2. BreadcrumbList schema (Dynamic)
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Luxury Jewellery Gifts", item: PAGE_URL },
    ],
  },
  ...
  // 3. ItemList schema
  {
    ...
    description: "Explore 25 luxury jewellery gift designs from the Barosche collection.",
    url: PAGE_URL,
    numberOfItems: 25,
  ...
  // 4. FAQPage schema
  {
    ...
    "@id": `${PAGE_URL}#faq`,
    url: `${PAGE_URL}#faq`,
    name: "Frequently Asked Questions About Luxury Jewellery Gifts",
