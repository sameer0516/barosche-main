import LuxuryJewelleryDetail from './LuxuryJewelleryDetail.jsx';
...
export default async function LuxuryJewelleryDetailPage({ params }) {
    const { slug } = await params;
    const product = await getProduct(slug);
    ...
    return (
        <>
            ...
            <LuxuryJewelleryDetail slug={slug} />
        </>
    );
}