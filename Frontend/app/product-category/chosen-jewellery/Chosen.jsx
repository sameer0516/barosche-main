...
const chosenJewelleryContent = [
    ...
    { type: 'p', text: "<b>Modern jewellery</b> styling is about finding your own balance—mixing trends with timeless pieces to create a look that feels authentic, stylish, and uniquely yours." },
