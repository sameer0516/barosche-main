...
const CATEGORY_NAME = "Chosen";
const CATEGORY_SLUG = "chosen-jewellery";
...
export async function generateStaticParams() {
    return generateCategoryStaticParams('Chosen');
}
...
export async function generateMetadata({ params }) {
    ...
    const pageUrl = `${siteUrl}/product-category/chosen-jewellery/${product.slug}`;
    ...
    const title = `${product.title || product.name} | Barosche Chosen Jewellery`;
...
export default async function ChosenDetailPage({ params }) {
    const { slug } = await params;
    const product = await getProduct(slug);
