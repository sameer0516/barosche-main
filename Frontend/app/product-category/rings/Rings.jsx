    ...
    useEffect(() => {
        ...
        async function run() {
            ...
            try {
                ...
                const cc =
                    detectData.countryCode ??
                    detectData.country ??
                    detectData.country_code ??
                    detectData.geo?.countryCode ??
                ...
                if (!cancelled) {
                    if (cc) {
                        ...
                        console.warn(
                            "[Rings] countryCode field detect-language response me nahi mila — " +
                            "isliye currency EUR (default) hi rahegi. Upar wala console.log dekh ke " +
                            "confirm karo backend actual me kaunsi key bhej raha hai."
                        );
                    }
                }
...
const UI_STRINGS = [
    ...
    // 82-94
    "<h3>1. Gold Rings – Classic & Timeless Appeal</h3>",
    ...
    "<h3>2. Diamond Rings – Elegant & Eye-Catching</h3>",
    ...
    "<h3>3. Silver Rings – Modern & Versatile</h3>",
    ...
    "<h3>4. Statement Rings – Bold & Fashion-Forward</h3>",
    ...
    "<h3>5. Rings for Men – Strong & Stylish Designs</h3>",
    ...
    "<h3>6. Rings for Women – Elegant & Trendy Styles</h3>",
    ...
    "<h3>1. Minimal Rings – Clean & Timeless Elegance</h3>",
    ...
    "<h3>2. Geometric Rings – Modern & Structured Designs</h3>",
    ...
    "<h3>3. Stackable Rings – Trendy Layered Styling</h3>",
    ...
    "<h3>4. Textured & Artistic Rings – Unique Statement Appeal</h3>",
    ...
    "<h3>5. Unisex Rings – Versatile & Inclusive Fashion<h3>",
    ...
    "<h3>2. Choose the Right Material</h3>",
    ...
    "<h3>3. Focus on Fit and Comfort</h3>",
    ...
    "<h3>5. Check Craftsmanship and Quality</h3>",
    ...
    // 182-190
    "<h3>1. Wear a Single Minimal Ring for Elegant Simplicity</h3>",
    ...
    "<h3>2. Stack Multiple Rings for a Trendy Look</h3>",
    ...
    "<h3>3. Pair Statement Rings with Simple Outfits</h3>",
    ...
    "<h3>4. Mix Metals for a Contemporary Aesthetic</h3>",
    ...
    "<h3>Perfect for Every Special Occasion</h3>",
    "<b>Rings make an ideal gift for a wide range of meaningful moments, including:</b>",
        ...
        >
            ...
            >
                ...
                <div style={{ flex: '1 1 280px', padding: '32px 24px 24px 16px', minWidth: '240px' }}>
                    ...
                    {/* Price */}
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'center', marginBottom: '20px' }} suppressHydrationWarning>
                        {variant.oldPrice && (
                            <span style={{ fontSize: '15px', color: '#aaa', textDecoration: 'line-through' }} suppressHydrationWarning>
                                {formatPrice(variant.oldPrice, currency)}
                            </span>
                        )}
                        <span style={{ fontSize: '18px', fontWeight: '600', color: '#1a1a1a' }} suppressHydrationWarning>
    ...
    return (
        ...
        >
            ...
            <div className="jw-card-body">
                ...
                <div className="jw-card-price" suppressHydrationWarning>
                    {oldPrice && (
                        <span className="jw-old-price" suppressHydrationWarning>
                            {formatPrice(oldPrice, currency)}
                        </span>
                    )}
                    {newPrice !== null && newPrice !== undefined ? (
                        <span className="jw-new-price" suppressHydrationWarning>
...
export default function Rings({ initialProducts = [] }) {
    ...
    const T = mounted ? rawT : UI_STRINGS;

    const [currency, setCurrency] = useState(CURRENCY_MAP.default);
    useEffect(() => {
        if (!countryCode) return;
        const normalizedCode = String(countryCode).trim().toUpperCase();
        if (CURRENCY_MAP[normalizedCode]) {
            setCurrency(CURRENCY_MAP[normalizedCode]);
        } else {
            console.warn(
                `[Rings] "${normalizedCode}" CURRENCY_MAP me exist nahi karta, ` +
                `isliye EUR (default) currency use ho rahi hai. CURRENCY_MAP me ` +
                `is country code ko add karo agar support karna hai.`
            );
        ...
        <div className="jw-page">
            ...
            <div className="jw-layout" ref={layoutRef}>
                                        ...
                                        {translatedCategories.map((c) => (
                                            <li key={c.name}>
                                                ...
                                                >
                                                    ...
                                                    <span className="jw-cat-name" suppressHydrationWarning>{c.displayName}</span>
                                                </button>
                                            </li>
                                        ))}
                                    </ul>
                ...
                <main className="jw-main">
                    ...
                    <h1 className="jw-title" suppressHydrationWarning>{T[3]}</h1>

                    {/* ── Toolbar ── */}
                    <div className="jw-toolbar">
                        <span className="jw-results-count" suppressHydrationWarning>
                            {loading
                                ? T[4]
                        ...
                        <div className="jw-toolbar-right">
                            <div className="jw-per-page">
                                <span className="jw-per-label" suppressHydrationWarning>{T[8]}</span>
                                {[12, 15, 30].map((n) => (
                                    <button
                                        key={n}
                    ...
                    <div className="jw-grid">
                        {loading ? (
                            ...
                            <div className="jw-empty" suppressHydrationWarning>
            ...
            <div className="jw-bottom-accordions">
                ...
                <AccordionItem title={T[16]}>
                    <div className="jw-accordion-text" suppressHydrationWarning>
                        {RINGS_CONTENT_STRUCTURE.map((item, i) => {
                            if (item.type === 'h2') {
                                return <h2 key={i} className="jw-accordion-heading" suppressHydrationWarning dangerouslySetInnerHTML={{ __html: T[item.idx] }} />;
                            }
                            if (item.type === 'h3') {
                                return <h3 key={i} className="jw-accordion-heading" style={{ marginTop: '20px', fontSize: '18px' }} suppressHydrationWarning dangerouslySetInnerHTML={{ __html: T[item.idx] }} />;
                            }
                            if (item.type === 'p') {
                                return <p key={i} suppressHydrationWarning dangerouslySetInnerHTML={{ __html: T[item.idx] }} />;
                            }
                            if (item.type === 'ul') {
                                return (
                                    <ul key={i} style={{ paddingLeft: '20px', marginBottom: '16px' }}>
                                        {item.items.map((liIdx, j) => (
                                            <li key={j} suppressHydrationWarning dangerouslySetInnerHTML={{ __html: T[liIdx] }} />
                                        ))}
                                    </ul>
                                );
                            }
                ...
                <AccordionItem title={T[17]}>
                    <div className="jw-faq-list" suppressHydrationWarning>
                        {Array.from({ length: FAQ_COUNT }, (_, i) => (
                            <div key={i} className="jw-faq-item">
                                <p className="jw-faq-q" suppressHydrationWarning>{i + 1}. {T[33 + i]}</p>
                                <p className="jw-faq-a" suppressHydrationWarning>{T[53 + i]}</p>
                            </div>
                        ))}
                    </div>
                </AccordionItem>
