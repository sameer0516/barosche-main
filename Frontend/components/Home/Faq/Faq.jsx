...
const INITIAL_ACCORDION_DATA = [
  {
    ...
    blocks: [
      ...
      { tag: "p", text: "Every piece is developed with attention to durability and design longevity, ensuring it remains stylish across seasons and trends. With our curated selection of <strong> fine jewellery online <strong>, you can invest in pieces that offer both beauty and lasting value." },

      { tag: "h2", text: "Shop Rings, Pendants, Earrings & Bracelets" },
      { tag: "p", text: "At Barosche, we offer a complete jewellery collection designed to suit every preference, style, and occasion. Whether you're looking to<strong> buy jewellery online</strong> for everyday elegance or statement styling, our range of <strong>rings, pendants, earrings, and bracelets </strong>is crafted to deliver both beauty and versatility." },

      { tag: "p", text: "<h3><a href='/product-category/rings/' style='color: #007bff; text-decoration: underline;'>Rings </a>–Timeless Symbols of Style:</h3> Our rings are designed to reflect elegance, individuality, and modern sophistication. From sleek <strong>minimalist jewellery</strong> bands to bold statement pieces, each ring is crafted with precision, comfort, and long-lasting quality—making it perfect for both daily wear and special moments." },
      { tag: "p", text: "<h3><a href='/product-category/pendants/' style='color: #007bff; text-decoration: underline;'>Pendants</a> – Subtle Yet Striking: </h3> Our pendants are created to add a refined focal point to your look. With clean designs and premium finishes, they offer effortless styling whether worn alone or layered. These pieces are ideal for those who appreciate understated elegance with a contemporary touch." },
      { tag: "p", text: "<h3><a href='/product-category/earrings/' style='color: #007bff; text-decoration: underline;'>Earrings </a>– Everyday Elegance:</h3> Our earrings combine comfort with modern aesthetics, making them suitable for all-day wear. Designed to complement both casual and formal outfits, they are an essential part of any <strong>fine jewellery </strong>collection, offering versatility and timeless appeal." },
      { tag: "p", text: "<h3><a href='/product-category/bracelets/' style='color: #007bff; text-decoration: underline;'>Bracelets </a>– Effortless Luxury:</h3> Our bracelets are crafted to add a polished and sophisticated finish to your overall style. Designed with flexibility and elegance in mind, they seamlessly transition from everyday wear to occasion styling, making them a key part of your <strong> luxury accessories</strong> collection." },
      ...
      { tag: "p", text: "Designed to elevate your style, these <strong>luxury accessories</strong> add a refined touch to your overall presence while maintaining comfort and practicality." },
      ...
      { tag: "p", text: "<h3>Daily Wear Jewellery:</h3> <br> Our <strong>minimalist jewellery</strong> pieces are lightweight, comfortable, and ideal for everyday use. Designed with clean lines and subtle detailing, they enhance your look while maintaining effortless simplicity." },
      { tag: "p", text: "<h3>Occasion Jewellery:</h3> <br> Make every celebration memorable with elegant <strong>fine jewellery</strong> and <strong> diamond jewellery </strong> that elevate your presence. These refined designs are perfect for events, parties, and special moments where style matters most." },
      { tag: "p", text: "<h3>Gifting Jewellery:</h3> <br>Timeless and meaningful, our jewellery makes the perfect gift for any occasion. Whether it's a celebration or a personal milestone, these pieces are designed to create lasting impressions." },
      { tag: "p", text: "<h3>Fashion Jewellery Styling:</h3><br> Explore versatile designs that allow you to experiment with layering and modern trends. From subtle combinations to statement looks, our collection adapts to your unique style." },
      { tag: "p", text: "From <strong> earrings and rings </strong>to <strong>bracelets and pendants, </strong>every piece is carefully crafted to match your lifestyle while offering both functionality and elegance." },
      ...
      { tag: "p", text: "<strong>With our curated selection of  fine jewellery online, you benefit from:</strong><br/>• Secure and safe transactions<br/>• Detailed product descriptions with high-quality images<br/>• Premium materials and refined finishes<br/>• Smooth and user-friendly browsing experience<br/>• Reliable and timely delivery services" },
      ...
      { tag: "p", text: "If you're looking to <strong> buy jewellery online </strong>, explore our exclusive collection of <strong>semi-handmade jewellery, </strong>  including beautifully crafted <strong>rings, pendants, earrings, and bracelets, </strong>and redefine your style with confidence." }
    ]
  },
  {
    id: 2,
    ...
    faqs: [
      ...
      { q: "20. Why should I choose Barosche for buying jewellery online?", a: "Barosche offers a combination of <strong>fine jewellery, diamond jewellery,</strong> and <strong>luxury accessories</strong>, making it a trusted choice to <strong>buy jewellery</strong> online with confidence." }
    ]
  }
];
